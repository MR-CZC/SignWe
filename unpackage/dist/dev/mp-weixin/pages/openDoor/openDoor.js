  ...
  methods: {
    ...
    getLabStatus() {
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getLabStatus",
        method: "GET",
        success: (res) => {
    ...
    openDoor() {
      const token = common_vendor.index.getStorageSync("token");
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/openLab",
        method: "PUT",
        header: {
          Authorization: token
        },
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/Turing/SignWe/SignWe/pages/openDoor/openDoor.vue"]]);
