  ...
  methods: {
    ...
    getUserInfo() {
      ...
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getUserInfo",
        method: "GET",
        header: {
          Authorization: token
        },
    ...
    getYesterdayRecord() {
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getRecordYesterday",
        method: "GET",
        success: (res) => {
          if (res.data.code === 200) {
    ...
    getPersonalTotalTime() {
      ...
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getTotalTimeByUserId",
        method: "GET",
        header: {
          Authorization: token
        },
    ...
    getPersonalRecord() {
      ...
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getRecordByUserId",
        method: "GET",
        header: {
          Authorization: token
        },
    ...
    getTodayRecord() {
      ...
      common_vendor.index.request({
        url: "https://turingclock.raqtpie.xyz:9642/getTotalTimeByUserIdToday",
        method: "GET",
        header: {
          Authorization: token
        },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.t($data.todayTime),
    f: common_vendor.p({
      border: false
    }),
    g: common_vendor.t($data.name != "" && $data.className != "" ? $data.name + " | " + $data.className : "历史记录"),
    h: $data.name != "" && $data.className != ""
  }, $data.name != "" && $data.className != "" ? {} : {}, {
    i: common_vendor.t($data.totalTime),
    j: common_vendor.p({
      border: false
    }),
    k: $data.personalRecord.length == 0
  }, $data.personalRecord.length == 0 ? {
    l: common_vendor.o((...args) => $options.showPersonalRecord && $options.showPersonalRecord(...args))
  } : {
    m: common_vendor.f($data.personalRecord, (item, index, i0) => {
      return {
        a: common_vendor.t(item.chairId),
        b: common_vendor.t(item.date),
        c: common_vendor.t(item.time),
        d: index,
        e: "559c2ca8-7-" + i0 + ",559c2ca8-6"
      };
    })
  }, {
    n: common_vendor.o($options.handleConfirm),
    o: common_vendor.o($options.handleClose),
    p: $data.showModal
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/Turing/SignWe/SignWe/pages/history/history.vue"]]);
